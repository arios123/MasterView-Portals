...
export function ChangeOrderMaterialItem({
  item,
  isAdded = false,
    ...
    >
      ...
      <div className="flex items-center gap-1 md:gap-2 min-w-0 max-w-full overflow-x-hidden">
        <div className="flex flex-col items-start">
          ...
          <Input
            className={cn(
              'h-8 w-16 md:w-20 border-0 shadow-none focus-visible:border focus-visible:border-input focus-visible:ring-0 focus-visible:ring-offset-0 px-1 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none',
        ...
        {showPrices && (
          <>
            <div className="flex flex-col items-start">
              ...
              <Input
                className={cn(
                  'h-8 w-20 md:w-24 border-0 shadow-none focus-visible:border focus-visible:border-input focus-visible:ring-0 focus-visible:ring-offset-0 px-1 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none',
                  isDeleted && 'line-through',
            ...
            <div className="flex flex-col items-start">
              <span className={cn('text-sm text-muted-foreground min-w-[60px]', isDeleted && 'line-through')}>
