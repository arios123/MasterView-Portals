...
interface MaterialQuoteItemProps {
...
export function MaterialQuoteItem({
  item,
  onUpdateName,
  onUpdateQty,
  onUpdatePrice,
  ...
  return (
    <div className="border rounded-xl p-2 gap-1 flex flex-col min-w-0 max-w-full overflow-x-hidden">
      <Textarea
        ref={textareaRef}
